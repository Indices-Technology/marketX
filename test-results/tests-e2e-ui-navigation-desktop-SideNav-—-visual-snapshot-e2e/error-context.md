...
- Name: tests\e2e\ui\navigation.spec.ts >> desktop SideNav — visual snapshot
- Location: tests\e2e\ui\navigation.spec.ts:324:1
...
Locator: getByRole('button', { name: /search or verify a seller/i })
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /search or verify a seller/i })
        ...
        - generic [ref=e48]:
          - generic:
            ...
            - generic:
              - generic:
                - generic:
                  - heading "Buy safely from sellers you can trust." [level=1]:
                    - generic: Buy safely from sellers you can trust.
                  - generic [ref=e59]:
                    - generic [ref=e60]:
