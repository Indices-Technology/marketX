...
- Name: layers\ai\server\api\ai\__tests__\ai.spec.ts >> ai — generate-listing >> POST /api/ai/generate-listing returns 503 when API key not configured
- Location: layers\ai\server\api\ai\__tests__\ai.spec.ts:43:3
