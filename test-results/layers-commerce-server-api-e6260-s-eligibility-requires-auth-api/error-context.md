...
- Name: layers\commerce\server\api\products\[id]\reviews\__tests__\reviews.spec.ts >> seller reviews — public >> GET /api/seller/:id/reviews/eligibility requires auth
- Location: layers\commerce\server\api\products\[id]\reviews\__tests__\reviews.spec.ts:85:3
