...
- Name: tests\e2e\ui\navigation.spec.ts >> desktop SideNav — guest >> Discover link navigates to /discover
- Location: tests\e2e\ui\navigation.spec.ts:68:3
...
Call log:
  - waiting for locator('aside.fixed.left-0').getByRole('link', { name: /^discover$/i })
    - locator resolved to <a href="/discover" data-v-119f0440="" class="nav-button group">…</a>
