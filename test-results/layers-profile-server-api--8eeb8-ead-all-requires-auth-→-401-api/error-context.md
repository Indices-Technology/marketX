...
- Name: layers\profile\server\api\notifications\__tests__\notifications.spec.ts >> notifications — CRUD auth guards >> PATCH read-all requires auth → 401
- Location: layers\profile\server\api\notifications\__tests__\notifications.spec.ts:29:3
...
Call log:
  - → PATCH http://localhost:3000/api/shared/notifications/read-all
