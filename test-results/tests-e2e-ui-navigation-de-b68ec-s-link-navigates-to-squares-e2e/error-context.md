...
- Name: tests\e2e\ui\navigation.spec.ts >> desktop SideNav — guest >> Squares link navigates to /squares
- Location: tests\e2e\ui\navigation.spec.ts:75:3
...
Call log:
  - waiting for locator('aside.fixed.left-0').locator('a[href="/squares"]')
    - locator resolved to <a href="/squares" data-v-119f0440="" class="nav-button group">…</a>
