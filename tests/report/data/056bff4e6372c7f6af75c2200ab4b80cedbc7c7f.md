...
- Name: layers\ai\server\api\ai\__tests__\ai.spec.ts >> ai — enhance-description >> POST /api/ai/enhance-description rejects missing description
- Location: layers\ai\server\api\ai\__tests__\ai.spec.ts:64:3
