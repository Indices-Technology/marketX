...
- Name: layers\ai\server\api\ai\__tests__\ai.spec.ts >> ai — enhance-description >> POST /api/ai/enhance-description returns 503 when API key not configured
- Location: layers\ai\server\api\ai\__tests__\ai.spec.ts:91:3
