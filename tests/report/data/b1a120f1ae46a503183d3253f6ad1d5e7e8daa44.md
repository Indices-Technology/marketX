...
- Name: layers\profile\server\api\notifications\__tests__\notifications.spec.ts >> notifications — CRUD auth guards >> DELETE requires auth → 401
- Location: layers\profile\server\api\notifications\__tests__\notifications.spec.ts:35:3
...
Call log:
  - → DELETE http://localhost:3000/api/shared/notifications/1
